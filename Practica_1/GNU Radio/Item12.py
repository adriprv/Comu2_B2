...
import Item12_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class Item12(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Item12")
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-12, 12)
        ...
        labels = ['Señal de Entrada', 'Señal de Salida', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_number_sink_0.set_title("La media")
...
def main(top_block_cls=Item12, options=None):
